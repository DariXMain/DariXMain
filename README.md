...
#### ⚛️ فریمورک و کتابخونه (فرانت‌اند)
...
### 🔥 علایق حرفه‌ای / Interests

- 🌐 توسعه وب و نرم‌افزار (Full-Stack)
- 🛡️ امنیت سایبری
- 📱 توسعه برنامه‌های موبایل و دسکتاپ
- 🗄️ معماری دیتابیس و طراحی API (REST + WebSocket)
- 🔌 مهندسی سخت‌افزار و شبکه
...
### 🧩 نقل قولی از من / A quote

> **"هرچی بیشتر یاد میگیرم، میفهمم چقدر چیزها هست که نمیدونم. اما همون باعث ادامه دادنمه."**
